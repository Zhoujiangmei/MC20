...
int nmea_pack_type(const char *buff, int buff_sz)
{
    ...
    if(buff_sz < sizeof(pheads)/sizeof(pheads[0]))
        return GPNON;
...
int nmea_parse_GPGGA(const char *buff, int buff_sz, nmeaGPGGA *pack)
{
    ...
    char szTmp[] = "$GPGGA,%s,%f,%C,%f,%C,%d,%d,%f,%f,%C,%f,%C,%f,%d*";

    if(s_GGA_Type == GNGGA)
        strcpy(szTmp,"$GNGGA,%s,%f,%C,%f,%C,%d,%d,%f,%f,%C,%f,%C,%f,%d*");
...
int nmea_parse_GPRMC(const char *buff, int buff_sz, nmeaGPRMC *pack)
{
    int nsen;
    char time_buff[NMEA_TIMEPARSE_BUF];
    char szTmp[] = "$GPRMC,%s,%C,%f,%C,%f,%C,%f,%f,%2d%2d%2d,%f,%C,%C*";

    if(s_RMC_Type == GNRMC)
        strcpy(szTmp,"$GNRMC,%s,%C,%f,%C,%f,%C,%f,%f,%2d%2d%2d,%f,%C,%C*");
...
void nmea_parse_GGASetHead(u16 usHeadType)
{
    s_GGA_Type = usHeadType;
}

void nmea_parse_RMCSetHead(u16 usHeadType)
{
    s_RMC_Type = usHeadType;
}

void nmea_parse_GSVSetHead(u16 usHeadType)
{
    s_GSV_Type = usHeadType;
}